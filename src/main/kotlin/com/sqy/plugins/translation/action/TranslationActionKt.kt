package com.sqy.plugins.translation.action
...
import com.sqy.plugins.translation.ui.BalloonPositionTracker

class TranslationActionKt : AnAction() {

    private val logger = Logger.getInstance(TranslationActionKt::class.java)
