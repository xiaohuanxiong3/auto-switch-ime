...
object UI {
    ...
    private fun Font.deriveScaledFont(size: Float): JBFont = JBFont.create(deriveFont(JBUIScale.scale(size)), false)
    ...
    fun getFonts(primaryFontSize: Int, phoneticFontSize: Int): FontPair {
        return FontPair(
            // TODO 暂时使用默认字体，后续添加设置
            getFont(null, primaryFontSize),
            getFont(null, phoneticFontSize)
        )
    }
